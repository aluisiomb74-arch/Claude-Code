# Checklist de TI — Envio de e-mail via Microsoft Graph (SQ DocGuard)

**Para:** Equipe de TI / Administrador do Microsoft 365.
**Objetivo:** Habilitar o envio automático de e-mails da plataforma SQ DocGuard (alertas de vencimento + e-mails de cadastro/reset) usando o Microsoft Graph, a partir do domínio corporativo, sem SMTP nem DNS.
...
2. Nome: `SQ DocGuard - Alertas`. Tipo: **single tenant**. Sem Redirect URI.
...
Criar uma **caixa de correio compartilhada** (sem licença) que será o remetente: `MS_GRAPH_SENDER` (ex.: `notificacoes@sqquimica.com`).
...
- Cadastro é restrito ao domínio **@sqquimica.com** (ajustável no schema).
